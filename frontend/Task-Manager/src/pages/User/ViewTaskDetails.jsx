...
const ViewTaskDetails = () => {
    ...
    // Lidar com o completar de itens de uma tarefa
        ...
        if (todoChecklist && todoChecklist[index]) {
            ...
            try {
                ...
                if (response.status === 200) {
                    ...
                    //Opicionalmente, reverte o toggle se a chamada de API falhar
                    todoChecklist[index].completed = !todoChecklist[index].completed;
                }
            } catch (error) {
                todoChecklist[index].completed = !todoChecklist[index.completed];
    ...
    const  handleLinkClick = async (link) => {
        if(!/^https?:\/\//i.test(link)) {
            link = 'https://' + link; // Padrão para HTTPS
        }
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-4 mt-4'>
                        <div className='form-card col-span-3'>
                            ...
                            <div className='grid grid-cols-12 gap-4 mt-4'>
                                ...
                                <div className='col-span-6 md:col-span-4'>
                                    <InfoBox label='Data Final'
                                        value={
                                            task?.dueDate
                                                ? moment(task?.dueDate).utc().format('D [de] MMMM [de] YYYY')
                                                : 'N/A'
                                        }
                                    />
                                </div>
